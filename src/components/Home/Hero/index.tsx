...
const cards = [
	...
	},
	{
		name: 'Facebook',
		description: (
			<p>Follow our Facebook page for the most up to date info</p>
		),
		icon: NewspaperIcon,
		href: facebook,
	},
			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8 h-full flex flex-col justify-center items-end">
				<div className="mx-auto max-w-2xl lg:mx-0">
					...
					<p className="mt-6 text-lg leading-8 text-white p-4 bg-white/5 rounded-xl">
						At Cumberland Food Stop, we think good food and quality
						ingredients should be available to everyone at prices
						that don’t cost an arm and a leg. We started operating
						in Cumberland, Maine in 1998. Since then, we’ve seen
						plenty of changes in the way people approach food — and
						we couldn’t be more excited. Come and check us out in
